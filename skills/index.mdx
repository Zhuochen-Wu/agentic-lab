...
| Daily News Watcher | [`skills/daily-news-watcher/README.md`](https://github.com/Prompthon-IO/agentic-lab/blob/main/skills/daily-news-watcher/README.md) | SQLite-backed persistent news monitoring, RSS/Atom + optional Playwright fetching, URL+hash deduplication, and per-run Markdown reports |
